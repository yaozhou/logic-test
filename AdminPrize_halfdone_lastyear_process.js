...
export default class extends Component {
    ...
    componentDidMount() {
        query('/api/last_prize', {}).then(function(ret) {
            this.setState({prize : ret.last_month, last_year_prize : ret.last_year}) ;
        }.bind(this))
    }
    ...
    make_table(prize_list) {
      let content = prize_list.map(function(v, idx) {
                  return (   
    ...
    render () {
            last_month = make_table(this.state.prize);
